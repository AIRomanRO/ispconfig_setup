        ...
        case $PACKAGE_NAME in
            ...
            "ssh" )
				...
				if [ -f /bin/ssh ] || [ -f /usr/bin/ssh ]; then
					...
					apt-get -o Dpkg::Options::="--force-confnew" --force-yes -yqq install ssh >> $PROGRAMS_INSTALL_LOG_FILES 2>&1
					echo -e " [ ${green}DONE${NC} ]"
				fi
		    ;;
            "openssh-server" )
				...
				apt-get -o Dpkg::Options::="--force-confnew" --force-yes -yqq install openssh-server -t jessie >> $PROGRAMS_INSTALL_LOG_FILES 2>&1
				echo -e " [ ${green}DONE${NC} ] "				
		    ;;
            "openssh-server-stretch" )
				...
				apt-get -o Dpkg::Options::="--force-confnew" --force-yes -yqq install openssh-server -t stretch >> $PROGRAMS_INSTALL_LOG_FILES 2>&1
				echo -e " [ ${green}DONE${NC} ]"
		    ;;
			"openssl-stable" )
				#Check for openssl
				...
				apt-get -o Dpkg::Options::="--force-confnew" --force-yes -yqq install openssl -t jessie >> $PROGRAMS_INSTALL_LOG_FILES 2>&1
				echo -e " [ ${green}DONE${NC} ]"
		    ;;
            "openssl-stretch" )
				#Check for openssh-server-stretch
				...
				apt-get -o Dpkg::Options::="--force-confnew" --force-yes -yqq install openssl -t stretch >> $PROGRAMS_INSTALL_LOG_FILES 2>&1
				echo -e " [ ${green}DONE${NC} ]"
		    ;; 
        esac
    done
