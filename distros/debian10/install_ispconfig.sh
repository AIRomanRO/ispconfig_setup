...
InstallISPConfig() {
  ...
  wget -q -O $PROGRAMS_INSTALL_DOWNLOAD/ISPConfig-3-stable-latest.tar.gz https://ispconfig.org/downloads/ISPConfig-3.1.15p2.tar.gz >>$PROGRAMS_INSTALL_LOG_FILES 2>&1
